...
import com.app.blockaat.productlisting.interfaces.OnHeaderDisplay;

public class StickHeaderItemDecoration extends RecyclerView.ItemDecoration {

    private StickyHeaderInterface mListener;
    private OnHeaderDisplay displayListener;
    private int mStickyHeaderHeight;

    public StickHeaderItemDecoration(@NonNull StickyHeaderInterface listener, OnHeaderDisplay displayListener) {
    ...
    private View getHeaderViewForItem(int headerPosition, RecyclerView parent) {
        ...
        header.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Log.v("Header click","header clicked");
            }
        });
        return header;
    }
    ...
    private void drawHeader(Canvas c, View header) {
        ...
        header.draw(c);
        c.restore();
        displayListener.isHeaderDisplay(true);
    ...
    private void moveHeader(Canvas c, View currentHeader, View nextHeader) {
        ...
        c.restore();
        displayListener.isHeaderDisplay(false);
    }
