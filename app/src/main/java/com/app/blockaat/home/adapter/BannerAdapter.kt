...
class BannerAdapter internal constructor(
    ...
    init {
        ...
        height = Global.getDimenVallue(mContext!!, 165.0)
    ...
    override fun instantiateItem(view: View, position: Int): Any {
        ...
        val imageLayout = inflater.inflate(R.layout.item_home_banner, null)

        val params =
            RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, height.toInt())
