/*
package com.app.boutikey.orders.adapter

import android.content.Context

class OrderDetailsAdapter(private val myOrderItemDetailData: CheckoutDataModel, private val paymentDataJson: JSONObject?, private val strPaymentType: String) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    class HeaderHolderView(itemView: View?, val activity: Context) : RecyclerView.ViewHolder(itemView!!) {
        fun bind(myOrderItemDetailData: CheckoutDataModel, paymentDataJson: JSONObject?, strPaymentType: String) {
            //set header data
            itemView.txtOrderNo.text = activity.resources.getString(
                R.string.order_no,
                myOrderItemDetailData.order_details.order_number.toString()
            )
    ...
    class FooterHolderView(itemView: View?, val activity: Context) : RecyclerView.ViewHolder(itemView!!) {
        fun bind(myOrderItemDetailData: CheckoutDataModel, paymentDataJson: JSONObject?, strPaymentType: String) {
            ...
            if (!v.first_name.isNullOrEmpty()) {
                itemView.txtFirstName!!.text = v.first_name
                itemView.linFirstName.visibility = View.VISIBLE
            } else {
                itemView.linFirstName.visibility = View.GONE
            }

            if (!v.last_name.isNullOrEmpty()) {
                itemView.txtLastName!!.text = v.last_name
                itemView.linLastName.visibility = View.VISIBLE
            } else {
                itemView.linLastName.visibility = View.GONE
            }
