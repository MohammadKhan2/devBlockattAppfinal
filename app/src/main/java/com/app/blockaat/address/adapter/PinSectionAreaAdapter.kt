...
class PinSectionAreaAdapter(val activity: AppCompatActivity) :
    BaseAlphabeticalAdapter<com.app.blockaat.address.model.AreaListDataModel>(activity) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(
            R.layout.lv_item_state_list_child, parent,
            false
        )
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        //set data
        val viewHolder =
            holder as com.app.blockaat.address.adapter.PinSectionAreaAdapter.ItemViewHolder
        ...
        viewHolder.relMainHolder.setOnClickListener {
            val intent = Intent()
            intent.putExtra("area_name", entityList[position]!!.name.toString())
            intent.putExtra("area_id", entityList[position]!!.id.toString())
            intent.putExtra("area_has", entityList[position]!!.has_blocks.toString())
    ...
    override fun onCreateHeaderViewHolder(parent: ViewGroup): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(
            R.layout.lv_item_state_list_header,
            parent, false
        )
        return com.app.blockaat.address.adapter.PinSectionAreaAdapter.HeaderViewHolder(
            itemView
        )
    }
    ...
    override fun onBindHeaderViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        val headerViewHolder =
            viewHolder as com.app.blockaat.address.adapter.PinSectionAreaAdapter.HeaderViewHolder
