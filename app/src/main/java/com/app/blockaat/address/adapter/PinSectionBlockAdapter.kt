...
class PinSectionBlockAdapter(val activity: AppCompatActivity) : BaseAlphabeticalAdapter<com.app.blockaat.address.model.BlockListDataModel>(activity) {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        //set data
        val viewHolder = holder as com.app.blockaat.address.adapter.PinSectionBlockAdapter.ItemViewHolder
       ...
       /* if ("ar".equals(Global.getStringFromSharedPref(activity, Constants.PREFS_LANGUAGE).toLowerCase())) {
        ...
        viewHolder.relMainHolder.setOnClickListener {
            val intent = Intent()
            intent.putExtra("block_name", entityList[position]!!.name)
            intent.putExtra("block_id", entityList[position]!!.id.toString())
    ...
    override fun onCreateHeaderViewHolder(parent: ViewGroup): RecyclerView.ViewHolder {
        ...
        return com.app.blockaat.address.adapter.PinSectionBlockAdapter.HeaderViewHolder(
            itemView
        )
    }

    override fun onBindHeaderViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        val headerViewHolder = viewHolder as com.app.blockaat.address.adapter.PinSectionBlockAdapter.HeaderViewHolder
