package com.app.blockaat.expadablerecylerview;
...
import com.app.blockaat.expadablerecylerview.model.ExpandableWrapper;
import com.app.blockaat.expadablerecylerview.model.Parent;
...
public abstract class ExpandableRecyclerAdapter<P extends Parent<C>, C, PVH extends ParentViewHolder, CVH extends ChildViewHolder>
     ...
     * from the viewholder)
     * <p>
     * Implement this in your {@link AppCompatActivity} or {@link Fragment}
     ...
     * <p>
     * Should be called from {@link AppCompatActivity#onSaveInstanceState(Bundle)} in
